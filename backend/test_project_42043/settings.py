"""
Django settings for test_project_42043 project.
...
ROOT_URLCONF = 'test_project_42043.urls'
...
WSGI_APPLICATION = 'test_project_42043.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_project_42043 API",
    "DESCRIPTION": "API documentation for test_project_42043 App",
    "VERSION": "v1",
}
